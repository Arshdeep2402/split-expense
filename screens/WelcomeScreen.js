    ...
    <ScreenWrapper>
      <View className="h-full flex justify-around">
        <View className='flex-row justify-center mt-10'>
            <Image source={require('../assets/images/welcome.gif')} className="w-96 h-96 shadow" />
        </View>

        <View className="mx-5 mb-20">
            <Text className={`text-center font-bold text-4xl ${colors.heading} mb-10`}>ExpSplitz</Text>
